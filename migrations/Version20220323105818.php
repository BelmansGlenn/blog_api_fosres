 ...
 */
final class Version20220323105818 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE answer ADD CONSTRAINT FK_DADD4A257294869C FOREIGN KEY (article_id) REFERENCES article (id) ON DELETE CASCADE');
    }
